...
$aColumns = array('id','ssb','kabupaten','provinsi','tahun','posisi');

 /* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "[id]";
  
/* DB table to use */
$sTable = "[fossbat].[dbo].[tbl_data_pemain-pendidikan]"; 
$condition = " id_pemain='$id' AND";
$condition2 = "WHERE id_pemain='$id' ";
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
