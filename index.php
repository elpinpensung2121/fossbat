...
<head>
  ...
  <title>FOSSBAT| Login</title>

  <link rel="shortcut icon" type="image/x-icon" href="../assets/fossbat.png" />
  <!-- Font Awesome -->
...
<body class="main-bg">
        <div class="login-container text-c animated flipInX">
                <div>
                    ...
                    <h3 class="text-whitesmoke">FOSSBAT | ADMIN</h3>
                    <p class="text-whitesmoke">Login</p>
                <div class="container-content">
                    <form class="margin-t" action="process/login.php" method="POST">
